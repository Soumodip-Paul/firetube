...
public class PostProfileAdapter extends FirestoreRecyclerAdapter<Post,PostProfileAdapter.PostViewHolder> {
     ...
     *
     */
    public PostProfileAdapter(@NonNull FirestoreRecyclerOptions<Post> options, CommentAdapter listener, LikeAdapter listener2, @Nullable ViewPostListener onPostItemSelectedListener) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull PostViewHolder holder, int position, @NonNull Post model) {
        ...
        holder.likeButton.setText(String.valueOf(model.getLikedBy().size()));/*this code should be debugged*/
